...
public class Search_Petitions extends JFrame{
	public Search_Petitions() {
		JTable t;
		Connection c = null;
		Statement stmt = null;
		getContentPane().setBackground(new Color(91,215,215));
	      try {
	         ...
	         ResultSet rs = stmt.executeQuery("select * from Petitions;");
	         String[][] data = new String[50][50];
	         String[] columnNames = {"Title","Category","Description"};
	         int s=0;
	         while ( rs.next() ) {
	        	 int j=0;
		         ...
		         data[s][j] = id;
		         j++;
		         String  u = rs.getString("Category");
		         data[s][j] = u;
		         j++;
		         String x = rs.getString("Description");
		         data[s][j] =x;
		         j=0;
		         s++;
